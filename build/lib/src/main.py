# ==========================================================================
#  Projektname · src/main.py
#  ----------------------------------------------------
#  Haupt-Entry-Point für DBTicker.
#
...
def load_routes() -> list[dict]:
    ...
    return [apply_defaults(route) for route in raw_routes]
...
def process_route(
    ...
    *,
    ...
    decision = decide_notification(
        ...
        all_clear_window_start_min=route["all_clear_window_start_min"],
        all_clear_window_end_min=route["all_clear_window_end_min"],
    )
