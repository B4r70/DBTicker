# ==========================================================================
#  Projektname · src/messagecodes.py
#  ----------------------------------------------------
#  Fehlercode-Registry: Übersetzt DB-API Message-Codes in lesbare Infos.
#
...
class _Registry:
    ...
    def _load(self) -> dict[str, dict]:
        ...
        try:
            ...
            codes: dict[str, dict] = data.get("codes", {})
            logger.debug("messagecodes geladen: %d Einträge", len(codes))
