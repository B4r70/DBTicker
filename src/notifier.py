...
#  Geändert am . : 04.05.2026  — komplett umgestellt: jetzt POST an BartoLink
# ------------------------------------------------------------------------------------------
#  Beschreibung  : Strukturiertes Event an BartoLink schicken.
#                  BartoLink aggregiert pro Trip, entscheidet über Push-Sichtbarkeit
#                  und versendet via APNs an iOS.
#
#                  Vorher: OpenClaw → Ollama-Agent-Satz → HTML → Telegram.
#                  Jetzt:  Trip-Event als JSON → /trips/events.
# ------------------------------------------------------------------------------------------
